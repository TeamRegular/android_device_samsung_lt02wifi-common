...
rm -rfv ../../../vendor/$VENDOR/$DEVICE/proprietary
...
for FILE in `cat proprietary-files.txt | grep -v ^# | grep -v ^$`; do
    ...
    #Blobs/System dump has to reside one directory below croot, change as apropriate:
    cp ../../../../blobdiffs/Samsung/$FILE ../../../vendor/$VENDOR/$DEVICE/proprietary/$FILE
done
