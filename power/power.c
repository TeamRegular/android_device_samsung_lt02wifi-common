...
#define LOG_TAG "PXA986 PowerHAL"
#include <utils/Log.h>
...
static void pxa986_set_interactive(struct power_module *module, int on)
{
...
static int boostpulse_open(struct pxa986_module *cm)
{
    char buf[80];
...
static void pxa986_hint(struct power_module *module, power_hint_t hint,
                            void *data)
{
    struct pxa986_module *cm = (struct pxa986_module *) module;
    char buf[80];
    int len;
    int duration = 1;
...
static void pxa986_init(struct power_module *module)
{
...
struct pxa986_module HAL_MODULE_INFO_SYM = {
    base: {
        common: {
            ...
            name: "PXA986 Power HAL",
            author: "The CyanogenMod Project",
            methods: &power_module_methods,
        },
       init: pxa986_init,
       setInteractive: pxa986_set_interactive,
       powerHint: pxa986_hint,
    },
